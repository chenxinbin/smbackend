            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="name" class="form-control" id="inputName" placeholder="请输入分类名称">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="slug" class="form-control" id="inputSlug" placeholder="请输入网址SLUG">
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="form-buttons">
                <div class="loading-indicator-container">
                    <button type="submit" data-request="category_save_ajax" data-load-indicator="Saving..." class="btn btn-primary" data-disposable="">
                        Create                </button>
                    <span class="btn-text">
                        or <a href="{{route('backend.cms.category')}}">Cancel</a>
                    </span>
                </div>
            </div>
          </div>
